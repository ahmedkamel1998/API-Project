...
<head>
  ...
  <title>Admin Elite | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('posts.index')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin Elite</span>
    </a>
...
<div class="content-wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">Ahmed Kamel</a>.</strong> All rights reserved.
</footer>
